...
XS_EUPXS(XS_VIM_Blob); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_VIM_Blob)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "sv");
    {
#line 1562 "if_perl.xs"
    STRLEN	len;
    char	*s;
    unsigned	i;
    char	buf[3];
...
XS_EUPXS(XS_VIM_Buffers)
{
    ...
    SP -= items;
    {
#line 1584 "if_perl.xs"
    buf_T *vimbuf;
    int i, b;

#line 1821 "if_perl.c"
#line 1588 "if_perl.xs"
    if (items == 0)
    {
	if (GIMME == G_SCALAR)
	{
...
XS_EUPXS(XS_VIM_Windows)
{
    ...
    SP -= items;
    {
#line 1635 "if_perl.xs"
    win_T   *vimwin;
    int	    i, w;

#line 1884 "if_perl.c"
#line 1639 "if_perl.xs"
    if (items == 0)
    {
	if (GIMME == G_SCALAR)
...
#  endif
        ...
        (void)newXSproto_portable("VIM::Blob", XS_VIM_Blob, file, "$");
